...
sap.ui.define([
	...
	return {
						...
						success: function(oVariantList) {
							...
							return this.waitFor({
								...
								matchers: function(oVariantItem) {
									return oVariantItem.getId().indexOf(sSVMId + "-trigger-item-") >= 0;
								},
		...
		theOpenManageViewsDialogTitleShouldContain: function (aVariantNames) {
			return this.waitFor({
				controlType: "sap.ui.comp.variants.EditableVariantItem",
				success: function(aManageVariantItems) {

					var aIsVariantTitle = [];
					aManageVariantItems.forEach(function(oItem) {
						var oCell = oItem.getCells()[VariantManagement.NAME_COLUMN];
		...
		theOpenManageViewsDialogFavoritesShouldContain: function (aVariantFavorites) {
			return this.waitFor({
				...
				success: function(aManageVariantItems) {
					...
					aManageVariantItems.forEach(function(oItem) {
						var oCell = oItem.getCells()[VariantManagement.FAV_COLUMN];
		...
		theOpenManageViewsDialogApplyAutomaticallyShouldContain: function (aVariantApplayAutos) {
			return this.waitFor({
				...
				success: function(aManageVariantItems) {
					...
					aManageVariantItems.forEach(function(oItem) {
						var oCell = oItem.getCells()[VariantManagement.EXEC_COLUMN];
			...
			return this.waitFor({
				...
				success: function(aManageVariantItems) {
					...
					if (!oListItem){
						...
						var oDefault = oListItem.getCells()[VariantManagement.DEF_COLUMN];
