...
sap.ui.define([
    ...
    var waitForEditableVariantItemByVariantName = function(sVariantName, oSettings) {
		return this.waitFor({
			...
			actions: function(oEditableVariantItem) {
				var oCell = oEditableVariantItem.getCells()[VariantManagement.NAME_COLUMN];
	...
	return {
		...
		iOpenMyView: function (sSVMId) {
			return this.iPressButtonWithID(sSVMId + "-trigger");
		},
		...
		iOpenSaveView: function (sSVMId) {
			return this.iPressButtonWithID(sSVMId + "-saveas");
		},
		...
		iOpenManageViews: function (sSVMId) {
			return this.iPressButtonWithID(sSVMId + "-manage");
		},
		...
		iPressTheManageViewsSave: function (sSVMId) {
			return this.iPressButtonWithID(sSVMId + "-managementsave");
		},
