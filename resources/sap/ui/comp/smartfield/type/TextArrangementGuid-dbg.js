...
sap.ui.define([
	 ...
	 * @override
	 */
	TextArrangementGuid.prototype.formatValue = function (sValue) {
		sValue = TextArrangementType.prototype.formatValue.apply(this, arguments);

		if (
			this.oFormatOptions.textArrangement === "descriptionOnly" &&
			sValue === "00000000-0000-0000-0000-000000000000"
		) {
			sValue = "";
		}
