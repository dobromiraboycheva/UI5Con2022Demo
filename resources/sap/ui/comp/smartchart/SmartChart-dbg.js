...
sap.ui.define([
	...
	SmartChart.prototype._createChart = function() {
		...
		if (oChart) {
			...
			try {
				var oDateFormatSettings = this.data("dateFormatSettings") ? JSON.parse(this.data("dateFormatSettings")) : {};
				// Default to UTC true if nothing is provided --> as sap:display-format="Date" should be used without a timezone
				if (oDateFormatSettings.hasOwnProperty("UTC") && oDateFormatSettings["UTC"]) {
					bShowUTC = true;
				}
