...
sap.ui.define([
	...
	TableProvider.prototype._intialiseMetadata = function() {
		...
		if (sSupportedFormats) {
			...
			this._bSupportsPDFExport = sSupportedFormats.indexOf("pdf") > -1;
		}
		this._oPdfAnnotation =  this._bSupportsPDFExport && this._oMetadataAnalyser.getPDFSupportedAnnotation();
